        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-md p-4 mb-4">
                <div class="flex justify-between mb-3">
                    <div class="mb-2 font-bold">Data Building</div>
                    <a href="{{ route('building.create') }}" class="bg-blue-950 text-white rounded-md text-sm py-2 px-3">Tambah Data Building</a>
                </div>
                        ...
                        <tbody>
                            @foreach ($buildings as $building)
                                <tr class="bg-white border-b">
                                    ...
                                    <td scope="row"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <img src="{{ asset('images/buildings/' . $building->image) }}" alt="{{ $building->name }}" width="200">
                                    </td>
                                    <td scope="row"
                                        class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $building->created_at }}
